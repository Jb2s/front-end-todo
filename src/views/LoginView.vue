      ...
      <div>
        <form
          ...
          :class="[
            ...
            errorCode === 'U010' ? 'border-2 border-red-500' : 'border',
          ]"
        >
          ...
          <div class="mb-4">
            ...
            <input
              ...
              required
              :class="[
                'mt-1 block w-full border rounded-md p-2 focus:ring focus:ring-indigo-200',
                errorCode === 'U001'
                  ? 'border-2 border-red-500 focus:ring focus:ring-red-300'
                  : 'border-gray-300',
              ]"
            />
          </div>
